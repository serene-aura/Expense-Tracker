...
const App = (function(){
    ...
    const updatePieChart = function(){
        const earned = +document.querySelector(UICtrl.getSelectors().moneyEarned).innerHTML;
        const spent = +document.querySelector(UICtrl.getSelectors().moneySpent).innerHTML;
        const available = earned - spent;

        pieChart.data.datasets[0].data = [earned, spent, available];
        pieChart.update();
    }
...
const pieChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: ['#43aa8b', '#f94144', '#f3722c'],
            borderWidth: 1
        }]
    },
    options: {
